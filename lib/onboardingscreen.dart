...
List<OnboardingContent> contents = [
  OnboardingContent(
    title: 'Discover Groudon',
    description: 'Explore the world of pokemon.',
    icon: Icons.search_rounded,
  ),
  OnboardingContent(
    title: 'Keep the enjoyment',
    description: 'Keep your pokemon happy.',
    icon: Icons.alarm
  ),
  OnboardingContent(
    title: 'Get Started',
    description: 'Choose your best pokemon to take care of.',
    icon: Icons.shopping_bag, // Try changing this to Icons.check_circle
  ),
];
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        color: currentIndex == index
            ? Theme.of(context).primaryColor // Color of the active dot
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(
                          ...
                          color:Color.fromARGB(255, 249, 165, 196), 
                        ),
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                            fontSize: 16, 
                            color: Color.fromARGB(255, 249, 165, 196), // Changes the description text color
                          ),
                        )
                      ],
                    ),
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      foregroundColor: Color.fromARGB(255, 249, 165, 196),                   // Button text color
